...
var author$project$Msgs$GotWords = function (a) {
	return {$: 'GotWords', a: a};
};
...
var author$project$Commands$getWords = function (source) {
	var url = A3(
		...
		_List_fromArray(
			[
				A2(elm$url$Url$Builder$string, 'source', source)
			]));
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		...
		var model = A3(author$project$Model$initialModel, url, key, route);
		return _Utils_Tuple2(
			model,
			author$project$Commands$getWords(model.source));
	});
...
var author$project$Msgs$VisibilityChange = function (a) {
...
var author$project$Subs$subscriptions = function (model) {
	var _n0 = model.status;
	if (_n0.$ === 'InProgress') {
		return elm$core$Platform$Sub$batch(
			_List_fromArray(
				[
					A2(elm$time$Time$every, 100, author$project$Msgs$Tick),
					elm$browser$Browser$Events$onVisibilityChange(author$project$Msgs$VisibilityChange)
				]));
	} else {
...
var author$project$Commands$focusID = function (id) {
	return A2(
...
var author$project$Msgs$StartGame = function (a) {
...
var author$project$Msgs$StopTimer = function (a) {
...
var author$project$Model$InProgress = function (a) {
	return {$: 'InProgress', a: a};
};
var author$project$Model$Success = function (a) {
	return {$: 'Success', a: a};
};
var author$project$Model$KeyComparison = F3(
	function (typed, target, correct) {
		return {correct: correct, target: target, typed: typed};
	});
var author$project$Utils$counter = function (items) {
	return A3(
		elm$core$List$foldr,
		F2(
			function (item, carry) {
...
var author$project$Utils$countMisstyped = F2(
	function (typed, target) {
		var comparisons = A3(
			...
			F2(
				function (a, b) {
					return A3(
						author$project$Model$KeyComparison,
						a,
						b,
						_Utils_eq(a, b));
				}),
	...
	function (msg, model) {
		switch (msg.$) {
			case 'UpdateSource':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{source: source}),
					author$project$Commands$getWords(source));
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								words: author$project$Model$Success(
									elm$core$String$toList(fullText))
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var err = result.a;
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							route: author$project$Routing$toRoute(
								elm$url$Url$toString(url)),
							url: url
						}),
					elm$core$Platform$Cmd$none);
			case 'StartGame':
				...
				if (_n3.$ === 'Success') {
					var words = _n3.a;
					var game = {currentWPM: 0, startTime: time, words: words};
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
				...
				if (_n4.$ === 'InProgress') {
					...
					var wordCount = elm$core$List$length(
						A2(
							...
							' ',
							elm$core$String$fromList(game.words)));
					...
					var result = {accuracy: 0.1, totalTime: totalTime, worstKeys: missTyped, wpm: wpm};
			...
			case 'UpdateTyped':
				...
				switch (_n5.$) {
					...
					default:
						var game = _n5.a;
						return _Utils_eq(
							elm$core$List$length(game.words),
							elm$core$List$length(typedCharacters)) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{typed: typedCharacters}),
							author$project$Commands$stopTimer) : _Utils_Tuple2(
							_Utils_update(
								model,
								{typed: typedCharacters}),
							elm$core$Platform$Cmd$none);
			...
			case 'Reset':
				var newModel = A3(author$project$Model$initialModel, model.url, model.key, model.route);
				return _Utils_Tuple2(
					_Utils_update(
						newModel,
						{source: model.source, words: model.words}),
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								author$project$Commands$focusTextInput,
								author$project$Commands$getWords(model.source)
							])));
			default:
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var author$project$View$navbar = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('nes-container with-title is-dark')
		]),
	_List_fromArray(
		[
			A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											A2(elm$html$Html$Attributes$style, 'color', 'white'),
											A2(elm$html$Html$Attributes$style, 'padding-right', '2em'),
...
var author$project$View$aboutView = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'margin', '5rem')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('nes-container with-title'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('nes-list is-disc')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												elm$html$Html$text('Frontend - Elm')
											])),
										A2(
										elm$html$Html$li,
										_List_Nil,
										_List_fromArray(
											[
												elm$html$Html$text('Backend - Flask')
											])),
										A2(
										elm$html$Html$li,
										_List_Nil,
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$html$Html$Attributes$href('https://nostalgic-css.github.io/NES.css/')
															]),
														_List_fromArray(
															[
																elm$html$Html$text('NES.css')
															]))
													]))
											]))
									]))
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$href('https://twitter.com/ThisIsJackEvans')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_Nil),
										elm$html$Html$text('@Jackevansevo')
									])),
								A2(
								elm$html$Html$i,
								_List_fromArray(
...
var author$project$Msgs$FocusInput = {$: 'FocusInput'};
var author$project$Msgs$Reset = {$: 'Reset'};
var author$project$Msgs$ToggleViewSettings = {$: 'ToggleViewSettings'};
var author$project$Msgs$UpdateSource = function (a) {
	return {$: 'UpdateSource', a: a};
};
var author$project$Msgs$UpdateTyped = function (a) {
	return {$: 'UpdateTyped', a: a};
};
...
var author$project$View$onPaste = function (message) {
	return A2(
...
var author$project$View$progressBar = function (model) {
	var _n0 = model.words;
	if (_n0.$ === 'Success') {
		var words = _n0.a;
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('nes-progress is-primary'),
					A2(elm$html$Html$Attributes$style, 'margin', '2rem 0'),
					A2(elm$html$Html$Attributes$style, 'height', '1.4rem'),
					elm$html$Html$Attributes$value(
					elm$core$String$fromInt(typedIndex)),
					elm$html$Html$Attributes$max(
					elm$core$String$fromInt(targetLength))
				]),
			_List_Nil);
	} else {
		return elm$html$Html$text('');
...
var author$project$View$displayCharacter = F2(
	function (c, freq) {
		var key = _Utils_eq(
			c,
			_Utils_chr(' ')) ? 'space' : elm$core$String$fromChar(c);
		return A2(
			elm$html$Html$span,
			_List_fromArray(
				[
	...
	if (elm$core$List$isEmpty(result.worstKeys)) {
		...
		var showKey = function (_n0) {
			...
			return A2(
				...
				_List_fromArray(
					[
						A2(author$project$View$displayCharacter, character, freq)
					]));
		};
		return A2(
			elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('Problematic Keys:')
						])),
					A2(
					elm$html$Html$div,
					_List_fromArray(
					...
					A2(elm$core$List$map, showKey, topWorst))
				]));
	}
};
	...
	if (_n0.$ === 'Finished') {
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					A2(myrho$elm_round$Round$round, 2, result.wpm) + ' WPM'),
					author$project$View$problematicKeys(result)
				]));
	} else {
		return elm$html$Html$text('');
	}
...
var author$project$Utils$padList = F3(
	function (list, pad, length) {
		return A2(
			elm$core$List$append,
			list,
			A2(
				elm$core$List$repeat,
				length - elm$core$List$length(list),
				pad));
	});
...
var author$project$View$zip = F2(
	function (xs, ys) {
		return A3(elm$core$List$map2, elm$core$Tuple$pair, xs, ys);
	});
var author$project$View$testProgress = function (model) {
	var textContainer = elm$html$Html$div(
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('nes-container is-rounded feedback noselect'),
	...
	if (_n0.$ === 'Success') {
		...
		var targetLength = elm$core$List$length(words);
		var diff = A2(
			author$project$View$zip,
			words,
			A3(
				author$project$Utils$padList,
				model.typed,
				_Utils_chr(' '),
				targetLength));
		var character = function (_n1) {
			var index = _n1.a;
			var _n2 = _n1.b;
			var target = _n2.a;
			var typed = _n2.b;
			return _Utils_eq(index, typedIndex) ? A2(
				elm$html$Html$span,
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'border-bottom-style', 'solid'),
						A2(elm$html$Html$Attributes$style, 'border-bottom-width', '2px'),
						A2(elm$html$Html$Attributes$style, 'border-bottom-color', 'black')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromChar(target))
					])) : ((_Utils_cmp(index, typedIndex) < 0) ? (_Utils_eq(target, typed) ? A2(
				elm$html$Html$span,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'border-bottom-style', 'solid'),
						A2(elm$html$Html$Attributes$style, 'border-bottom-width', '2px'),
						A2(elm$html$Html$Attributes$style, 'border-bottom-color', '#e76e55')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
				...
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'color', '#e76e55')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
		...
		return textContainer(
			A2(
				elm$core$List$map,
				character,
				A2(elm$core$List$indexedMap, elm$core$Tuple$pair, diff)));
	} else {
		return textContainer(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('loader__dot')
								]),
							_List_fromArray(
								[
									elm$html$Html$text('.')
...
var author$project$View$wpmCount = function (model) {
	var _n0 = model.status;
	switch (_n0.$) {
		case 'InProgress':
			var game = _n0.a;
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('wpmBar noselect')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(myrho$elm_round$Round$round, 2, game.currentWPM) + ' WPM')
					]));
		case 'Finished':
			var result = _n0.a;
			return A2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Start typing!')
							])),
						A2(
						elm$html$Html$button,
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onClick(author$project$Msgs$ToggleViewSettings)
							]),
						_List_fromArray(
							[
...
var author$project$View$homeView = function (model) {
	var settings = model.showSettings ? A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'position', 'absolute'),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('nes-icon close is-small'),
								A2(elm$html$Html$Attributes$style, 'position', 'absolute'),
											...
											[
												...
												_List_fromArray(
													[
														...
														author$project$Msgs$UpdateSource('trump'))
													]),
												_List_Nil),
												A2(
												elm$html$Html$span,
											...
											[
												...
												_List_fromArray(
													[
														...
														elm$html$Html$Attributes$type_('radio'),
														elm$html$Html$Events$onClick(
														author$project$Msgs$UpdateSource('shakespeare'))
													]),
												_List_Nil),
												A2(
												elm$html$Html$span,
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Events$onMouseEnter(author$project$Msgs$FocusInput),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								settings,
								author$project$View$wpmCount(model),
								author$project$View$progressBar(model),
								author$project$View$testProgress(model),
								A2(
								elm$html$Html$input,
								_List_fromArray(
									[
										...
										elm$html$Html$Events$onInput(author$project$Msgs$UpdateTyped),
										author$project$View$onPaste(author$project$Msgs$NoOp),
										elm$html$Html$Attributes$value(
										elm$core$String$fromList(model.typed))
									]),
								_List_Nil),
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$id('resetButton'),
										elm$html$Html$Events$onClick(author$project$Msgs$Reset),
										elm$html$Html$Attributes$class('nes-btn is-success')
									]),
								_List_fromArray(
									[
		...
		case 'Home':
			return {
				body: _List_fromArray(
					[
						author$project$View$homeView(model)
					]),
				title: 'Typestest'
			};
		case 'About':
			return {
				body: _List_fromArray(
					[
						author$project$View$aboutView(model)
					]),
				title: 'About Page'
			};
		default:
...
var author$project$Main$main = elm$browser$Browser$application(
	{init: author$project$Main$init, onUrlChange: author$project$Msgs$UrlChanged, onUrlRequest: author$project$Msgs$LinkClicked, subscriptions: author$project$Subs$subscriptions, update: author$project$Update$update, view: author$project$View$view});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Msgs.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Msgs.Msg":{"args":[],"tags":{"NoOp":[],"FocusInput":[],"UpdateTyped":["String.String"],"Tick":["Time.Posix"],"Reset":[],"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"GotWords":["Result.Result Http.Error String.String"],"VisibilityChange":["Browser.Events.Visibility"],"StartGame":["Time.Posix"],"StopTimer":["Time.Posix"],"ToggleViewSettings":[],"UpdateSource":["String.String"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Browser.Events.Visibility":{"args":[],"tags":{"Visible":[],"Hidden":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}}}}})}});}(this));