...
(function (scope) {
  ...
  */
  ...
  var author$project$Msgs$GotWords = function author$project$Msgs$GotWords(a) {
    return {
      $: 'GotWords',
      a: a
    };
  ...
  var author$project$Commands$getWords = elm$http$Http$get({
    expect: elm$http$Http$expectString(author$project$Msgs$GotWords),
    url: 'http://localhost:5000'
  });
  var author$project$Model$Loading = {
    $: 'Loading'
  };
  var author$project$Model$NotStarted = {
    $: 'NotStarted'
  };
  ...
  var author$project$Model$initialModel = F3(function (url, key, route) {
    return {
      key: key,
      route: route,
      source: 'shakespeare',
      status: author$project$Model$NotStarted,
      typed: _List_Nil,
      url: url,
      words: author$project$Model$Loading,
      zone: elm$time$Time$utc
    };
  });
  var author$project$Routing$NotFound = {
    $: 'NotFound'
  };
  var author$project$Routing$About = {
    $: 'About'
  };
  var author$project$Routing$Home = {
    $: 'Home'
  };
  ...
  var author$project$Routing$routeParser = elm$url$Url$Parser$oneOf(_List_fromArray([A2(elm$url$Url$Parser$map, author$project$Routing$Home, elm$url$Url$Parser$top), A2(elm$url$Url$Parser$map, author$project$Routing$About, elm$url$Url$Parser$s('about'))]));
  ...
  var author$project$Routing$toRoute = function author$project$Routing$toRoute(string) {
    ...
    if (_n0.$ === 'Nothing') {
      ...
      var url = _n0.a;
      return A2(elm$core$Maybe$withDefault, author$project$Routing$NotFound, A2(elm$url$Url$Parser$parse, author$project$Routing$routeParser, url));
    }
  };
  ...
  var author$project$Main$init = F3(function (flags, url, key) {
    var route = author$project$Routing$toRoute(elm$url$Url$toString(url));
    return _Utils_Tuple2(A3(author$project$Model$initialModel, url, key, route), author$project$Commands$getWords);
  });

  var author$project$Msgs$LinkClicked = function author$project$Msgs$LinkClicked(a) {
    return {
      $: 'LinkClicked',
      a: a
    };
  ...
  var author$project$Msgs$UrlChanged = function author$project$Msgs$UrlChanged(a) {
    return {
      $: 'UrlChanged',
      a: a
    };
  ...
  var author$project$Msgs$Tick = function author$project$Msgs$Tick(a) {
    return {
      $: 'Tick',
      a: a
    };
  ...
  var author$project$Msgs$VisibilityChange = function author$project$Msgs$VisibilityChange(a) {
    return {
      $: 'VisibilityChange',
      a: a
    };
  ...
  var elm$browser$Browser$Events$onVisibilityChange = function elm$browser$Browser$Events$onVisibilityChange(func) {
  ...
  var author$project$Subs$subscriptions = function author$project$Subs$subscriptions(model) {
    var _n0 = model.status;

    if (_n0.$ === 'InProgress') {
      return elm$core$Platform$Sub$batch(_List_fromArray([A2(elm$time$Time$every, 100, author$project$Msgs$Tick), elm$browser$Browser$Events$onVisibilityChange(author$project$Msgs$VisibilityChange)]));
    } else {
      return elm$browser$Browser$Events$onVisibilityChange(author$project$Msgs$VisibilityChange);
    }
  };

  var author$project$Msgs$NoOp = {
    $: 'NoOp'
  };
  ...
  var author$project$Commands$focusID = function author$project$Commands$focusID(id) {
    return A2(elm$core$Task$attempt, function (_n0) {
      return author$project$Msgs$NoOp;
    }, elm$browser$Browser$Dom$focus(id));
  };

  var author$project$Commands$focusTextInput = author$project$Commands$focusID('textInput');

  var author$project$Msgs$StartGame = function author$project$Msgs$StartGame(a) {
    return {
      $: 'StartGame',
      a: a
    };
  ...
  var author$project$Commands$startGame = A2(elm$core$Task$perform, author$project$Msgs$StartGame, elm$time$Time$now);

  var author$project$Msgs$StopTimer = function author$project$Msgs$StopTimer(a) {
    return {
      $: 'StopTimer',
      a: a
    };
  ...
  var author$project$Commands$stopTimer = A2(elm$core$Task$perform, author$project$Msgs$StopTimer, elm$time$Time$now);

  var author$project$Model$Finished = function author$project$Model$Finished(a) {
    return {
      $: 'Finished',
      a: a
    };
  ...
  var author$project$Model$InProgress = function author$project$Model$InProgress(a) {
    return {
      $: 'InProgress',
      a: a
    };
  ...
  var author$project$Model$Success = function author$project$Model$Success(a) {
    return {
      $: 'Success',
      a: a
    };
  ...
  var author$project$Model$KeyComparison = F3(function (typed, target, correct) {
    return {
      correct: correct,
      target: target,
      typed: typed
  ...
  var author$project$Utils$counter = function author$project$Utils$counter(items) {
    return A3(elm$core$List$foldr, F2(function (item, carry) {
      return A3(elm$core$Dict$update, item, function (existingCount) {
  ...
  var author$project$Utils$countMisstyped = F2(function (typed, target) {
    var comparisons = A3(elm$core$List$map2, F2(function (a, b) {
      return A3(author$project$Model$KeyComparison, a, b, _Utils_eq(a, b));
    }), typed, target);
    return elm$core$List$reverse(A2(elm$core$List$sortBy, function (_n0) {
      var a = _n0.a;
      var b = _n0.b;
      return b;
    }, elm$core$Dict$toList(author$project$Utils$counter(A2(elm$core$List$map, function ($) {
      return $.target;
    }, A2(elm$core$List$filter, function (c) {
      return !c.correct;
    }, comparisons))))));
  });
    ...
    switch (msg.$) {
      ...
      case 'GotWords':
        ...
        if (result.$ === 'Ok') {
          ...
          return _Utils_Tuple2(_Utils_update(model, {
            words: author$project$Model$Success(elm$core$String$toList(fullText))
          }), elm$core$Platform$Cmd$none);
        } else {
          var err = result.a;
          return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
      ...
      case 'UrlChanged':
        var url = msg.a;
        return _Utils_Tuple2(_Utils_update(model, {
          route: author$project$Routing$toRoute(elm$url$Url$toString(url)),
          url: url
        }), elm$core$Platform$Cmd$none);
      ...
      case 'StartGame':
        ...
        if (_n3.$ === 'Success') {
          ...
          return _Utils_Tuple2(_Utils_update(model, {
            status: author$project$Model$InProgress(game)
          }), elm$core$Platform$Cmd$none);
        } else {
          return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
        }
      ...
      case 'StopTimer':
        ...
        if (_n4.$ === 'InProgress') {
          var game = _n4.a;
          var wordCount = elm$core$List$length(A2(elm$core$String$split, ' ', elm$core$String$fromList(game.words)));
          var totalTime = elm$time$Time$posixToMillis(endTime) - elm$time$Time$posixToMillis(game.startTime);
          var missTyped = A2(author$project$Utils$countMisstyped, model.typed, game.words);
          var inMinutes = totalTime / 60000;
          ...
          var newModel = _Utils_update(model, {
            status: author$project$Model$Finished(result)
          });
      ...
      case 'UpdateTyped':
        var input = msg.a;
        var typedCharacters = elm$core$String$toList(input);
        ...
        switch (_n5.$) {
          ...
          case 'NotStarted':
            ...
            }), author$project$Commands$startGame);

          default:
            var game = _n5.a;
            return _Utils_eq(elm$core$List$length(game.words), elm$core$List$length(typedCharacters)) ? _Utils_Tuple2(_Utils_update(model, {
              typed: typedCharacters
            }), author$project$Commands$stopTimer) : _Utils_Tuple2(_Utils_update(model, {
              typed: typedCharacters
            }), elm$core$Platform$Cmd$none);
        }
      ...
      case 'Tick':
        var time = msg.a;
        var _n6 = model.status;

        if (_n6.$ === 'InProgress') {
          var game = _n6.a;
          var wordCount = elm$core$List$length(A2(elm$core$String$split, ' ', elm$core$String$fromList(model.typed)));
          ...
          var wpm = wordCount / inMinutes;
          return _Utils_Tuple2(_Utils_update(model, {
            status: author$project$Model$InProgress(_Utils_update(game, {
              currentWPM: wpm
            }))
          }), elm$core$Platform$Cmd$none);
        } else {
      ...
      case 'FocusInput':
        return _Utils_Tuple2(model, author$project$Commands$focusTextInput);

      case 'Reset':
        return _Utils_Tuple2(A3(author$project$Model$initialModel, model.url, model.key, model.route), elm$core$Platform$Cmd$batch(_List_fromArray([author$project$Commands$focusTextInput, author$project$Commands$getWords])));
  ...
  var author$project$View$navbar = A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Attributes$class('container with-title is-dark')]), _List_fromArray([A2(elm$html$Html$h2, _List_fromArray([elm$html$Html$Attributes$class('title')]), _List_fromArray([elm$html$Html$text('Menu')])), A2(elm$html$Html$div, _List_Nil, _List_fromArray([A2(elm$html$Html$ul, _List_fromArray([A2(elm$html$Html$Attributes$style, 'color', 'white'), A2(elm$html$Html$Attributes$style, 'list-style', 'none'), A2(elm$html$Html$Attributes$style, 'margin', '0'), A2(elm$html$Html$Attributes$style, 'padding', '0')]), _List_fromArray([A2(elm$html$Html$li, _List_fromArray([A2(elm$html$Html$Attributes$style, 'display', 'inline'), A2(elm$html$Html$Attributes$style, 'padding-right', '0.8rem')]), _List_fromArray([A2(elm$html$Html$a, _List_fromArray([A2(elm$html$Html$Attributes$style, 'text-decoration', 'none'), A2(elm$html$Html$Attributes$style, 'color', 'white'), A2(elm$html$Html$Attributes$style, 'padding-right', '1em'), elm$html$Html$Attributes$href('/')]), _List_fromArray([elm$html$Html$text('Home')]))])), A2(elm$html$Html$li, _List_fromArray([A2(elm$html$Html$Attributes$style, 'display', 'inline'), A2(elm$html$Html$Attributes$style, 'padding-right', '0.8rem')]), _List_fromArray([A2(elm$html$Html$a, _List_fromArray([A2(elm$html$Html$Attributes$style, 'text-decoration', 'none'), A2(elm$html$Html$Attributes$style, 'color', 'white'), elm$html$Html$Attributes$href('/about')]), _List_fromArray([elm$html$Html$text('About')]))]))]))]))]));

  var author$project$View$aboutView = function author$project$View$aboutView(model) {
    return A2(elm$html$Html$div, _List_Nil, _List_fromArray([author$project$View$navbar, A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Attributes$id('container')]), _List_fromArray([A2(elm$html$Html$div, _List_Nil, _List_fromArray([elm$html$Html$text('This is the about page')]))]))]));
  };

  var author$project$Msgs$FocusInput = {
    $: 'FocusInput'
  };
  var author$project$Msgs$Reset = {
    $: 'Reset'
  };

  var author$project$Msgs$UpdateTyped = function author$project$Msgs$UpdateTyped(a) {
    return {
      $: 'UpdateTyped',
      a: a
    };
  ...
  var author$project$View$alwaysPreventDefault = function author$project$View$alwaysPreventDefault(msg) {
  ...
  var author$project$View$onPaste = function author$project$View$onPaste(message) {
    return A2(elm$html$Html$Events$preventDefaultOn, 'paste', A2(elm$json$Json$Decode$map, author$project$View$alwaysPreventDefault, elm$json$Json$Decode$succeed(message)));
  };
  ...
  var author$project$View$progressBar = function author$project$View$progressBar(model) {
    var _n0 = model.words;

    if (_n0.$ === 'Success') {
      var words = _n0.a;
      var typedIndex = elm$core$List$length(model.typed);
      var targetLength = elm$core$List$length(words);
      return A2(elm$html$Html$progress, _List_fromArray([A2(elm$html$Html$Attributes$style, 'width', '100%'), A2(elm$html$Html$Attributes$style, 'margin', '2rem 0'), elm$html$Html$Attributes$value(elm$core$String$fromInt(typedIndex)), elm$html$Html$Attributes$max(elm$core$String$fromInt(targetLength))]), _List_Nil);
    } else {
      return elm$html$Html$text('');
    }
  };
  ...
  var author$project$View$displayCharacter = F2(function (c, freq) {
    var key = _Utils_eq(c, _Utils_chr(' ')) ? 'space' : elm$core$String$fromChar(c);
    return A2(elm$html$Html$span, _List_fromArray([elm$html$Html$Attributes$class('btn'), A2(elm$html$Html$Attributes$style, 'font-size', '80%'), A2(elm$html$Html$Attributes$style, 'margin-right', '1rem'), A2(elm$html$Html$Attributes$style, 'display', 'block')]), _List_fromArray([elm$html$Html$text(key)]));
  });
  ...
  var author$project$View$problematicKeys = function author$project$View$problematicKeys(result) {
    if (elm$core$List$isEmpty(result.worstKeys)) {
      return elm$html$Html$text('');
    } else {
      var topWorst = A2(elm$core$List$take, 5, result.worstKeys);

      var showKey = function showKey(_n0) {
        var character = _n0.a;
        var freq = _n0.b;
        return A2(elm$html$Html$div, _List_Nil, _List_fromArray([A2(author$project$View$displayCharacter, character, freq)]));
      };

      return A2(elm$html$Html$div, _List_fromArray([A2(elm$html$Html$Attributes$style, 'padding-top', '2em')]), _List_fromArray([A2(elm$html$Html$p, _List_Nil, _List_fromArray([elm$html$Html$text('Problematic Keys:')])), A2(elm$html$Html$div, _List_fromArray([A2(elm$html$Html$Attributes$style, 'display', 'flex'), A2(elm$html$Html$Attributes$style, 'flex', 'row')]), A2(elm$core$List$map, showKey, topWorst))]));
    }
  };
  ...
  var myrho$elm_round$Round$increaseNum = function myrho$elm_round$Round$increaseNum(_n0) {
    var head = _n0.a;
    var tail = _n0.b;
  ...
  var myrho$elm_round$Round$toDecimal = function myrho$elm_round$Round$toDecimal(fl) {
    var _n0 = A2(elm$core$String$split, 'e', elm$core$String$fromFloat(elm$core$Basics$abs(fl)));
    ...
    if (_n0.b) {
      if (_n0.b.b) {
        ...
        var zeroed = e < 0 ? A2(elm$core$Maybe$withDefault, '0', A2(elm$core$Maybe$map, function (_n3) {
          var a = _n3.a;
          var b = _n3.b;
          return a + ('.' + b);
  ...
  var myrho$elm_round$Round$roundFun = F3(function (functor, s, fl) {
    if (elm$core$Basics$isInfinite(fl) || elm$core$Basics$isNaN(fl)) {
      ...
      var _n0 = myrho$elm_round$Round$splitComma(myrho$elm_round$Round$toDecimal(elm$core$Basics$abs(fl)));
  ...
  var author$project$View$score = function author$project$View$score(model) {
    var _n0 = model.status;

    if (_n0.$ === 'Finished') {
      var result = _n0.a;
      return A2(elm$html$Html$div, _List_fromArray([A2(elm$html$Html$Attributes$style, 'padding-top', '1rem')]), _List_fromArray([elm$html$Html$text(A2(myrho$elm_round$Round$round, 2, result.wpm) + ' WPM'), author$project$View$problematicKeys(result)]));
    } else {
      return elm$html$Html$text('');
    }
  };
  ...
  var author$project$Utils$padList = F3(function (list, pad, length) {
    return A2(elm$core$List$append, list, A2(elm$core$List$repeat, length - elm$core$List$length(list), pad));
  });
  var elm$core$Tuple$pair = F2(function (a, b) {
    return _Utils_Tuple2(a, b);
  });
  var author$project$View$zip = F2(function (xs, ys) {
    return A3(elm$core$List$map2, elm$core$Tuple$pair, xs, ys);
  });

  var author$project$View$testProgress = function author$project$View$testProgress(model) {
    var textContainer = elm$html$Html$div(_List_fromArray([elm$html$Html$Attributes$class('container feedback noselect')]));
    var _n0 = model.words;
    ...
    if (_n0.$ === 'Success') {
      ...
      var typedIndex = elm$core$List$length(model.typed);
      var targetLength = elm$core$List$length(words);
      var diff = A2(author$project$View$zip, words, A3(author$project$Utils$padList, model.typed, _Utils_chr(' '), targetLength));

      var character = function character(_n1) {
        var index = _n1.a;
        var _n2 = _n1.b;
        var target = _n2.a;
        var typed = _n2.b;
        return _Utils_eq(index, typedIndex) ? A2(elm$html$Html$span, _List_fromArray([A2(elm$html$Html$Attributes$style, 'border-bottom-style', 'solid'), A2(elm$html$Html$Attributes$style, 'border-bottom-width', '2px'), A2(elm$html$Html$Attributes$style, 'border-bottom-color', 'black')]), _List_fromArray([elm$html$Html$text(elm$core$String$fromChar(target))])) : _Utils_cmp(index, typedIndex) < 0 ? _Utils_eq(target, typed) ? A2(elm$html$Html$span, _List_fromArray([A2(elm$html$Html$Attributes$style, 'color', 'black')]), _List_fromArray([elm$html$Html$text(elm$core$String$fromChar(target))])) : _Utils_eq(target, _Utils_chr(' ')) ? A2(elm$html$Html$span, _List_fromArray([A2(elm$html$Html$Attributes$style, 'border-bottom-style', 'solid'), A2(elm$html$Html$Attributes$style, 'border-bottom-width', '2px'), A2(elm$html$Html$Attributes$style, 'border-bottom-color', '#e76e55')]), _List_fromArray([elm$html$Html$text(elm$core$String$fromChar(target))])) : A2(elm$html$Html$span, _List_fromArray([A2(elm$html$Html$Attributes$style, 'color', '#e76e55')]), _List_fromArray([elm$html$Html$text(elm$core$String$fromChar(target))])) : A2(elm$html$Html$span, _List_fromArray([A2(elm$html$Html$Attributes$style, 'color', 'lightgray')]), _List_fromArray([elm$html$Html$text(elm$core$String$fromChar(target))]));
      };

      return textContainer(A2(elm$core$List$map, character, A2(elm$core$List$indexedMap, elm$core$Tuple$pair, diff)));
    } else {
      return textContainer(_List_fromArray([A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Attributes$class('loader')]), _List_fromArray([A2(elm$html$Html$span, _List_fromArray([elm$html$Html$Attributes$class('loader__dot')]), _List_fromArray([elm$html$Html$text('.')])), A2(elm$html$Html$span, _List_fromArray([elm$html$Html$Attributes$class('loader__dot')]), _List_fromArray([elm$html$Html$text('.')])), A2(elm$html$Html$span, _List_fromArray([elm$html$Html$Attributes$class('loader__dot')]), _List_fromArray([elm$html$Html$text('.')]))]))]));
    }
  };

  var author$project$View$wpmCount = function author$project$View$wpmCount(model) {
    var _n0 = model.status;

    switch (_n0.$) {
      case 'InProgress':
        var game = _n0.a;
        return A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Attributes$class('wpmBar noselect')]), _List_fromArray([elm$html$Html$text(A2(myrho$elm_round$Round$round, 2, game.currentWPM) + ' WPM')]));

      case 'Finished':
        var result = _n0.a;
        return A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Attributes$class('wpmBar noselect')]), _List_fromArray([elm$html$Html$text(A2(myrho$elm_round$Round$round, 2, result.wpm) + ' WPM')]));

      default:
        return elm$html$Html$text('Start typing!');
    }
  };
  ...
  var elm$html$Html$Events$onMouseEnter = function elm$html$Html$Events$onMouseEnter(msg) {
    return A2(elm$html$Html$Events$on, 'mouseenter', elm$json$Json$Decode$succeed(msg));
  };

  var author$project$View$homeView = function author$project$View$homeView(model) {
    return A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Events$onMouseEnter(author$project$Msgs$FocusInput), elm$html$Html$Events$onClick(author$project$Msgs$FocusInput)]), _List_fromArray([author$project$View$navbar, A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Attributes$id('container')]), _List_fromArray([A2(elm$html$Html$div, _List_Nil, _List_fromArray([author$project$View$wpmCount(model), author$project$View$progressBar(model), author$project$View$testProgress(model), A2(elm$html$Html$input, _List_fromArray([elm$html$Html$Attributes$id('textInput'), elm$html$Html$Attributes$autofocus(true), elm$html$Html$Events$onInput(author$project$Msgs$UpdateTyped), author$project$View$onPaste(author$project$Msgs$NoOp), elm$html$Html$Attributes$value(elm$core$String$fromList(model.typed))]), _List_Nil), A2(elm$html$Html$button, _List_fromArray([elm$html$Html$Attributes$id('resetButton'), elm$html$Html$Events$onClick(author$project$Msgs$Reset), elm$html$Html$Attributes$class('btn is-primary')]), _List_fromArray([elm$html$Html$text('Reset')])), author$project$View$score(model)]))]))]));
  };

  var author$project$View$view = function author$project$View$view(model) {
    var _n0 = model.route;

    switch (_n0.$) {
      case 'Home':
        return {
          body: _List_fromArray([author$project$View$homeView(model)]),
          title: 'Typestest'
        };

      case 'About':
        return {
          body: _List_fromArray([author$project$View$aboutView(model)]),
          title: 'About Page'
        };

      default:
        return {
          body: _List_fromArray([elm$html$Html$text('Not Found')]),
          title: 'Not Found'
        };
    }
  };
  ...
  var author$project$Main$main = elm$browser$Browser$application({
    ...
    onUrlChange: author$project$Msgs$UrlChanged,
    onUrlRequest: author$project$Msgs$LinkClicked,
    subscriptions: author$project$Subs$subscriptions,
          ...
          "unions": {
            "Msgs.Msg": {
              ...
              "tags": {
                "NoOp": [],
                "FocusInput": [],
                "UpdateTyped": ["String.String"],
                "Tick": ["Time.Posix"],
                "Reset": [],
                "LinkClicked": ["Browser.UrlRequest"],
                "UrlChanged": ["Url.Url"],
                "GotWords": ["Result.Result Http.Error String.String"],
...
},{}]},{},["../../../n/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","elm.js"], null)
//# sourceMappingURL=/elm.b85ca40c.map